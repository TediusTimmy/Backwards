...
cd ../../bin
g++ -o AllTest -g -Wall -Wextra -Wpedantic --coverage -O0 -I../External/googletest/include -I../include ../Tests/DebuggerTest.cpp ../Tests/ExecutionTest.cpp ../Tests/ExpressionTest.cpp ../Tests/LexerTest.cpp ../Tests/ParserTest.cpp ../Tests/StatementTest.cpp ../Tests/StdLibTest.cpp ../Tests/TypesTest.cpp ../obj/*.o ../External/googletest/lib/libgtest.a ../External/googletest/lib/libgtest_main.a
