...
cd ../src
g++ -Wall -Wextra -Wpedantic -g --coverage -O0 -c -I../../Backwards/include -I../include *.cpp

cd ../bin
g++ -o BackwayTest -Wall -Wextra -Wpedantic -g --coverage -O0 -I../../Backwards/External/googletest/include -I../../Backwards/include -I../include ../Tests/StdLibTest.cpp ../src/*.o ../../Backwards/External/googletest/lib/libgtest.a ../../Backwards/External/googletest/lib/libgtest_main.a ../lib/Backwards.a
